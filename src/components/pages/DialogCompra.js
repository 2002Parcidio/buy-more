...
export default function CustomizedDialogs ({img1, titulo, descrição, price,}) {
    ...
    <div>
      ...
      >
        ...
        <div style={{textAlign:'center'}}>
          <img src={img1} style={{width:'300px', height:'350px'}}/>
        <br />
        <h4>{titulo}</h4>
        </div>
          <Typography gutterBottom style={{float:'left'}}>
            ...
            <br />
            <br />
            <p style={{}}>Email: mescbuymore@gmail.com</p>
            ...
            <a href="https://wa.me/921048213" class="whatsapp_float" target="_blank" rel="noopener noreferrer" style={{marginLeft:'0px'}}><button className='btn btn-dark' style={{backgroundColor:'#696969'}}><i className='fab fa-whatsapp' style={{color:'antiquewhite', fontSize:'30px', width:'100px', marginLeft:'2%', }}></i></button></a>
